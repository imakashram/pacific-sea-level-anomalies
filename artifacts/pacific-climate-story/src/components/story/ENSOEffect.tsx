          ...
          >
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
              <p className="text-sm text-muted-foreground max-w-xl">
                El Niño events temporarily suppress sea levels (warm/dip), while La Niña events 
                amplify them (cool/surge). This Dumbbell plot shows the range of this swing.
              </p>
              <div className="flex bg-card/30 p-1 rounded-full border border-border/50 self-start sm:self-auto flex-shrink-0">
                <button
            ...
            <div className="flex flex-wrap items-center gap-6 mb-8 text-xs text-muted-foreground bg-card/20 p-3 rounded-xl border border-border/30">
              ...
              <div className="flex items-center gap-2 ml-auto text-sky-400 font-mono hidden md:flex">
            ...
            <div className="bg-card/20 backdrop-blur-md border border-border/40 rounded-3xl p-6 md:p-8 shadow-2xl">
              {/* X-Axis Scale Header */}
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    {ensoData.nations.slice(0, 5).map((n, i) => (
                    ...
                    <div className="grid grid-cols-3 gap-3 text-center text-xs">
                      <div>
                        <div className="font-mono text-sm" style={{ color: ELNINO_COLOR }}>
                          {(ensoData.global.elNinoAvg * 100).toFixed(1)} cm
                        </div>
                        <div className="text-muted-foreground">El Niño avg</div>
                      </div>
                      <div>
                        <div className="font-mono text-sm text-muted-foreground">
                          {(ensoData.global.neutralAvg * 100).toFixed(1)} cm
                        </div>
                        <div className="text-muted-foreground">Neutral avg</div>
                      </div>
                      <div>
                        <div className="font-mono text-sm" style={{ color: LANINA_COLOR }}>
                          {(ensoData.global.laNinaAvg * 100).toFixed(1)} cm
                        </div>
            ...
            {ensoData && (
              <div className="mt-8 p-6 bg-primary/5 border border-primary/20 rounded-xl">
                <p className="text-base text-muted-foreground leading-relaxed">
                  ...
                  <span className="text-foreground font-mono">{(ensoData.global.elNinoAvg * 100).toFixed(1)} cm</span>.
